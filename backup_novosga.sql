...
CREATE TABLE public.atend_codif (
...
ALTER TABLE public.atend_codif OWNER TO novosga;

--
-- Name: atend_meta; Type: TABLE; Schema: public; Owner: novosga
--

CREATE TABLE public.atend_meta (
    atendimento_id bigint NOT NULL,
...
ALTER TABLE public.atend_meta OWNER TO novosga;
...
ALTER TABLE public.atendimentos OWNER TO novosga;
...
ALTER TABLE public.atendimentos_id_seq OWNER TO novosga;
...
ALTER TABLE public.cargos OWNER TO novosga;
...
ALTER TABLE public.cargos_id_seq OWNER TO novosga;
...
CREATE TABLE public.cargos_mod_perm (
...
ALTER TABLE public.cargos_mod_perm OWNER TO novosga;
...
ALTER TABLE public.config OWNER TO novosga;
...
ALTER TABLE public.contador OWNER TO novosga;
...
ALTER TABLE public.grupos OWNER TO novosga;
...
ALTER TABLE public.grupos_id_seq OWNER TO novosga;
...
CREATE TABLE public.historico_atend_codif (
    atendimento_id bigint NOT NULL,
    servico_id integer NOT NULL,
    valor_peso smallint NOT NULL
);
...
ALTER TABLE public.historico_atend_codif OWNER TO novosga;

--
-- Name: historico_atend_meta; Type: TABLE; Schema: public; Owner: novosga
--

CREATE TABLE public.historico_atend_meta (
    atendimento_id bigint NOT NULL,
    name character varying(50) NOT NULL,
    value text
);
...
ALTER TABLE public.historico_atend_meta OWNER TO novosga;
...
ALTER TABLE public.historico_atendimentos OWNER TO novosga;
...
ALTER TABLE public.locais OWNER TO novosga;
...
ALTER TABLE public.locais_id_seq OWNER TO novosga;
...
ALTER TABLE public.modulos OWNER TO novosga;
...
ALTER TABLE public.modulos_id_seq OWNER TO novosga;
...
ALTER TABLE public.oauth_access_tokens OWNER TO novosga;
...
ALTER TABLE public.oauth_clients OWNER TO novosga;
...
ALTER TABLE public.oauth_refresh_tokens OWNER TO novosga;
...
ALTER TABLE public.oauth_scopes OWNER TO novosga;
...
ALTER TABLE public.paineis OWNER TO novosga;

--
-- Name: paineis_servicos; Type: TABLE; Schema: public; Owner: novosga
--

CREATE TABLE public.paineis_servicos (
    host integer NOT NULL,
    unidade_id integer NOT NULL,
    servico_id integer NOT NULL
);
...
ALTER TABLE public.paineis_servicos OWNER TO novosga;

--
-- Name: painel_senha; Type: TABLE; Schema: public; Owner: novosga
--

CREATE TABLE public.painel_senha (
    id integer NOT NULL,
    unidade_id integer NOT NULL,
    servico_id integer NOT NULL,
    num_senha integer NOT NULL,
...
ALTER TABLE public.painel_senha OWNER TO novosga;

--
-- Name: painel_senha_id_seq; Type: SEQUENCE; Schema: public; Owner: novosga
--

CREATE SEQUENCE public.painel_senha_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.painel_senha_id_seq OWNER TO novosga;

--
-- Name: painel_senha_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: novosga
--

ALTER SEQUENCE public.painel_senha_id_seq OWNED BY public.painel_senha.id;
...
ALTER TABLE public.prioridades OWNER TO novosga;
...
ALTER TABLE public.prioridades_id_seq OWNER TO novosga;
...
ALTER TABLE public.serv_meta OWNER TO novosga;
...
ALTER TABLE public.servicos OWNER TO novosga;
...
ALTER TABLE public.servicos_id_seq OWNER TO novosga;
...
ALTER TABLE public.uni_meta OWNER TO novosga;

--
-- Name: uni_serv; Type: TABLE; Schema: public; Owner: novosga
--

CREATE TABLE public.uni_serv (
    unidade_id integer NOT NULL,
    servico_id integer NOT NULL,
...
ALTER TABLE public.uni_serv OWNER TO novosga;
...
ALTER TABLE public.unidades OWNER TO novosga;
...
ALTER TABLE public.unidades_id_seq OWNER TO novosga;
...
CREATE TABLE public.usu_grup_cargo (
...
ALTER TABLE public.usu_grup_cargo OWNER TO novosga;

--
-- Name: usu_meta; Type: TABLE; Schema: public; Owner: novosga
--

CREATE TABLE public.usu_meta (
    usuario_id integer NOT NULL,
    name character varying(50) NOT NULL,
    value text
);
...
ALTER TABLE public.usu_meta OWNER TO novosga;

--
-- Name: usu_serv; Type: TABLE; Schema: public; Owner: novosga
--

CREATE TABLE public.usu_serv (
    unidade_id integer NOT NULL,
    servico_id integer NOT NULL,
    usuario_id integer NOT NULL
);
...
ALTER TABLE public.usu_serv OWNER TO novosga;
...
ALTER TABLE public.usuarios OWNER TO novosga;
...
ALTER TABLE public.usuarios_id_seq OWNER TO novosga;
...
UNION ALL
 SELECT historico_atendimentos.id,
   ...
   FROM public.historico_atendimentos;


ALTER TABLE public.view_historico_atendimentos OWNER TO novosga;
...
ALTER TABLE ONLY public.painel_senha ALTER COLUMN id SET DEFAULT nextval('public.painel_senha_id_seq'::regclass);
...
COPY public.atend_codif (atendimento_id, servico_id, valor_peso) FROM stdin;
1	3	1
2	3	1
7	3	1
8	3	1
...
COPY public.atend_meta (atendimento_id, name, value) FROM stdin;
\.
...
COPY public.atendimentos (id, unidade_id, usuario_id, usuario_tri_id, servico_id, prioridade_id, atendimento_id, status, sigla_senha, num_senha, num_senha_serv, nm_cli, num_local, dt_cheg, dt_cha, dt_ini, dt_fim, ident_cli) FROM stdin;
...
COPY public.cargos (id, nome, descricao, esquerda, direita, nivel) FROM stdin;
...
COPY public.cargos_mod_perm (cargo_id, modulo_id, permissao) FROM stdin;
1	1	3
1	2	3
1	3	3
1	4	3
...
COPY public.config (chave, valor, tipo) FROM stdin;
version	1.5.0	1
...
COPY public.contador (unidade_id, total) FROM stdin;
2	0
3	9
\.
...
COPY public.grupos (id, nome, descricao, esquerda, direita, nivel) FROM stdin;
...
COPY public.historico_atend_codif (atendimento_id, servico_id, valor_peso) FROM stdin;
\.
...
COPY public.historico_atend_meta (atendimento_id, name, value) FROM stdin;
\.
...
COPY public.historico_atendimentos (id, unidade_id, usuario_id, usuario_tri_id, servico_id, prioridade_id, atendimento_id, status, sigla_senha, num_senha, num_senha_serv, nm_cli, num_local, dt_cheg, dt_cha, dt_ini, dt_fim, ident_cli) FROM stdin;
\.
...
COPY public.locais (id, nome) FROM stdin;
1	Guichê
2	Sala
3	Mesa
\.
...
COPY public.modulos (id, chave, nome, descricao, tipo, status) FROM stdin;
...
COPY public.paineis (unidade_id, host) FROM stdin;
\.
...
COPY public.paineis_servicos (host, unidade_id, servico_id) FROM stdin;
\.
...
COPY public.painel_senha (id, unidade_id, servico_id, num_senha, sig_senha, msg_senha, local, num_local, peso, prioridade, nome_cliente, documento_cliente) FROM stdin;
...
COPY public.prioridades (id, nome, descricao, peso, status) FROM stdin;
...
COPY public.serv_meta (servico_id, name, value) FROM stdin;
\.
...
COPY public.servicos (id, macro_id, descricao, nome, status, peso) FROM stdin;
...
COPY public.uni_meta (unidade_id, name, value) FROM stdin;
\.
...
COPY public.uni_serv (unidade_id, servico_id, local_id, sigla, status, peso) FROM stdin;
3	1	1	A	0	1
3	2	1	A	0	1
3	4	1	A	0	1
3	5	1	A	0	1
...
COPY public.unidades (id, grupo_id, codigo, nome, status, stat_imp, msg_imp) FROM stdin;
...
COPY public.usu_grup_cargo (usuario_id, grupo_id, cargo_id) FROM stdin;
1	1	1
2	6	2
3	5	2
4	5	2
...
COPY public.usu_meta (usuario_id, name, value) FROM stdin;
...
COPY public.usu_serv (unidade_id, servico_id, usuario_id) FROM stdin;
3	3	3
3	15	3
3	3	4
3	15	4
...
COPY public.usuarios (id, login, nome, sobrenome, senha, ult_acesso, status, session_id) FROM stdin;
...
SELECT pg_catalog.setval('public.atendimentos_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.grupos_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.modulos_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.painel_senha_id_seq', 14, true);
...
ALTER TABLE ONLY public.atend_codif
...
ALTER TABLE ONLY public.atend_meta
...
ALTER TABLE ONLY public.cargos_mod_perm
...
ALTER TABLE ONLY public.historico_atend_codif
...
ALTER TABLE ONLY public.paineis
...
ALTER TABLE ONLY public.paineis_servicos
...
ALTER TABLE ONLY public.painel_senha
...
ALTER TABLE ONLY public.serv_meta
...
ALTER TABLE ONLY public.uni_meta
...
ALTER TABLE ONLY public.uni_serv
...
ALTER TABLE ONLY public.usu_grup_cargo
...
ALTER TABLE ONLY public.usu_meta
...
ALTER TABLE ONLY public.usu_serv
...
CREATE UNIQUE INDEX codigo ON public.unidades USING btree (codigo);
...
CREATE INDEX direita ON public.grupos USING btree (direita);
...
CREATE INDEX esqdir ON public.grupos USING btree (esquerda, direita);
...
CREATE INDEX esquerda ON public.grupos USING btree (esquerda);
...
CREATE INDEX fki_atendimentos_ibfk_3 ON public.atendimentos USING btree (status);
...
CREATE UNIQUE INDEX local_serv_nm ON public.locais USING btree (nome);
...
CREATE UNIQUE INDEX login ON public.usuarios USING btree (login);
...
CREATE UNIQUE INDEX modulos_chave ON public.modulos USING btree (chave);
...
ALTER TABLE ONLY public.atend_codif
    ADD CONSTRAINT atend_codif_ibfk_1 FOREIGN KEY (atendimento_id) REFERENCES public.atendimentos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.atend_codif
    ADD CONSTRAINT atend_codif_ibfk_2 FOREIGN KEY (servico_id) REFERENCES public.servicos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.atend_meta
    ADD CONSTRAINT atend_meta_ibfk_1 FOREIGN KEY (atendimento_id) REFERENCES public.atendimentos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.atendimentos
    ADD CONSTRAINT atendimentos_ibfk_1 FOREIGN KEY (prioridade_id) REFERENCES public.prioridades(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.atendimentos
    ADD CONSTRAINT atendimentos_ibfk_2 FOREIGN KEY (unidade_id, servico_id) REFERENCES public.uni_serv(unidade_id, servico_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.atendimentos
    ADD CONSTRAINT atendimentos_ibfk_4 FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.atendimentos
    ADD CONSTRAINT atendimentos_ibfk_5 FOREIGN KEY (usuario_tri_id) REFERENCES public.usuarios(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.atendimentos
    ADD CONSTRAINT atendimentos_ibfk_6 FOREIGN KEY (atendimento_id) REFERENCES public.atendimentos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.cargos_mod_perm
    ADD CONSTRAINT cargos_mod_perm_ibfk_1 FOREIGN KEY (cargo_id) REFERENCES public.cargos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.cargos_mod_perm
    ADD CONSTRAINT cargos_mod_perm_ibfk_2 FOREIGN KEY (modulo_id) REFERENCES public.modulos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.contador
    ADD CONSTRAINT contador_unidade_id_fkey FOREIGN KEY (unidade_id) REFERENCES public.unidades(id);
...
ALTER TABLE ONLY public.historico_atend_codif
    ADD CONSTRAINT historico_atend_codif_ibfk_1 FOREIGN KEY (atendimento_id) REFERENCES public.historico_atendimentos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.historico_atend_codif
    ADD CONSTRAINT historico_atend_codif_ibfk_2 FOREIGN KEY (servico_id) REFERENCES public.servicos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.historico_atend_meta
    ADD CONSTRAINT historico_atend_meta_ibfk_1 FOREIGN KEY (atendimento_id) REFERENCES public.historico_atendimentos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.historico_atendimentos
    ADD CONSTRAINT historico_atendimentos_ibfk_1 FOREIGN KEY (prioridade_id) REFERENCES public.prioridades(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.historico_atendimentos
    ADD CONSTRAINT historico_atendimentos_ibfk_2 FOREIGN KEY (unidade_id, servico_id) REFERENCES public.uni_serv(unidade_id, servico_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.historico_atendimentos
    ADD CONSTRAINT historico_atendimentos_ibfk_4 FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.historico_atendimentos
    ADD CONSTRAINT historico_atendimentos_ibfk_5 FOREIGN KEY (usuario_tri_id) REFERENCES public.usuarios(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.historico_atendimentos
    ADD CONSTRAINT historico_atendimentos_ibfk_6 FOREIGN KEY (atendimento_id) REFERENCES public.historico_atendimentos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.paineis
    ADD CONSTRAINT paineis_ibfk_1 FOREIGN KEY (unidade_id) REFERENCES public.unidades(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.paineis_servicos
    ADD CONSTRAINT paineis_servicos_ibfk_1 FOREIGN KEY (host) REFERENCES public.paineis(host) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.paineis_servicos
    ADD CONSTRAINT paineis_servicos_ibfk_2 FOREIGN KEY (unidade_id, servico_id) REFERENCES public.uni_serv(unidade_id, servico_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.painel_senha
    ADD CONSTRAINT painel_senha_ibfk_1 FOREIGN KEY (unidade_id) REFERENCES public.unidades(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.painel_senha
    ADD CONSTRAINT painel_senha_ibfk_2 FOREIGN KEY (servico_id) REFERENCES public.servicos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.serv_meta
    ADD CONSTRAINT serv_meta_servico_id_fkey FOREIGN KEY (servico_id) REFERENCES public.servicos(id);
...
ALTER TABLE ONLY public.servicos
    ADD CONSTRAINT servicos_ibfk_1 FOREIGN KEY (macro_id) REFERENCES public.servicos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.uni_meta
    ADD CONSTRAINT uni_meta_unidade_id_fkey FOREIGN KEY (unidade_id) REFERENCES public.unidades(id);
...
ALTER TABLE ONLY public.uni_serv
    ADD CONSTRAINT uni_serv_ibfk_1 FOREIGN KEY (unidade_id) REFERENCES public.unidades(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.uni_serv
    ADD CONSTRAINT uni_serv_ibfk_2 FOREIGN KEY (servico_id) REFERENCES public.servicos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.uni_serv
    ADD CONSTRAINT uni_serv_ibfk_3 FOREIGN KEY (local_id) REFERENCES public.locais(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.unidades
    ADD CONSTRAINT unidades_grupo_id_fkey FOREIGN KEY (grupo_id) REFERENCES public.grupos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.usu_grup_cargo
    ADD CONSTRAINT usu_grup_cargo_ibfk_1 FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.usu_grup_cargo
    ADD CONSTRAINT usu_grup_cargo_ibfk_2 FOREIGN KEY (grupo_id) REFERENCES public.grupos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.usu_grup_cargo
    ADD CONSTRAINT usu_grup_cargo_ibfk_3 FOREIGN KEY (cargo_id) REFERENCES public.cargos(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.usu_meta
    ADD CONSTRAINT usu_meta_usuario_id_fkey FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id);
...
ALTER TABLE ONLY public.usu_serv
    ADD CONSTRAINT usu_serv_ibfk_1 FOREIGN KEY (servico_id, unidade_id) REFERENCES public.uni_serv(servico_id, unidade_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.usu_serv
    ADD CONSTRAINT usu_serv_ibfk_2 FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
